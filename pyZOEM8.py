...
class ZOEM8(object):
    ...
    def run(self):
        ...
        while True:
            ...
            console.addstr(17,0,'Speed-over-Ground: {:3.2f} knots'.format(self.speed_over_ground))
            console.addstr(18,0,'Course-over-Ground: {:3.2f} deg'.format(self.course_over_ground))
            console.addstr(19,0,'Magnetic Declination: {:3.2f} deg'.format(self.magnetic_declination))
            console.addstr(20,0,'')
